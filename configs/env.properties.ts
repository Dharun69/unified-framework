...
export module EnvProperties {
    ...
    export const Platform: EnvPropertiesEnums.Platform = EnvPropertiesEnums.Platform.localWeb;
    ...
    export const Browser: EnvPropertiesEnums.Browser = EnvPropertiesEnums.Browser.chrome;
